...
if (speed1 > speed2) {
    alert(`O ${name1} está a ${speed1} km/h e está mais rápido que ${name2}, que está a ${speed2} km/h!`);
} else if (speed1 < speed2) {
    alert(`O ${name2} está a ${speed2} km/h e está mais rápido que ${name1}, que está a ${speed1} km/h!`);
} else {
